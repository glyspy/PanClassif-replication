def step5(homepath,names,smoothed_cancer,smoothed_normal,scale_mode):
	...
	for index in range(len(names)):
		...
		cancer.to_csv(r''+parent_dir+'/cancer/'+names[index]+'.txt.bz2',compression="bz2", sep='\t',header=None,index=None,index_label=None) # type: ignore
		normal.to_csv(r''+parent_dir+'/normal/'+names[index]+'.txt.bz2',compression="bz2", sep='\t',header=None,index=None,index_label=None) # type: ignore
